...
public class carousel {
	...
	public int getCarousel_isshow() {
		return carousel_isshow;
	}

	public void setCarousel_isshow(int carousel_isshow) {
	...
	public int getCarousel_isdelete() {
		return carousel_isdelete;
	}

	public void setCarousel_isdelete(int carousel_isdelete) {
