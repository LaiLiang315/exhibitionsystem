...
private int production_pictures_isdelete; //是否删除
...
public int getProduction_pictures_sequence() {
	return production_pictures_sequence;
}
public void setProduction_pictures_sequence(int production_pictures_sequence) {
...
public int getProduction_pictures_isdelete() {
	return production_pictures_isdelete;
}
public void setProduction_pictures_isdelete(int production_pictures_isdelete) {
