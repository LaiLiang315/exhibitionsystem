...
<link rel="stylesheet" href="css/exhibition/style.css"  type="text/css" media="all" />
</head>
<body id="ruifoxHome">
<header>
	<div id="navbg"></div>
	<div class="wrapper">
		<h1 class="logo">
			<a href="index.htm"  title="">
				<img src="images/exhibition/logo.png" width="213" height="36" alt="" />
			</a>
		</h1>
		<nav>
			<ul>
...
<section id="banner">
  <ul id="banner_img">
    <li style="background-image:url(images/bg/banner_bg1.jpg);display:block">
      <div class="wrapper">
        <div class="ad_txt">
          <h2>互联网品牌传播解决方案</h2>
          <p>成都顶级品牌网站建设公司！<br/>
        ...
        <div class="ad_img"> <img src="images/exhibition/1.png"  width="506" height="404" alt="" /> </div>
      </div>
    </li>
    <li style="background-image:url(images/bg/banner_bg2.jpg);">
      <div class="wrapper">
        <div class="ad_txt">
        ...
        <div class="ad_img"> <img src="images/exhibition/2.png" width="506" height="404" alt="" /> </div>
      </div>
    </li>
    <li style="background-image:url(images/bg/banner_bg3.jpg);">
      <div class="wrapper">
        <div class="ad_txt">
          <h2>互联网时代的整合营销</h2>
        ...
        <div class="ad_img"> <img src="images/exhibition/3.png" width="506" height="404" alt="" /> </div>
      </div>
    </li>
    <li style="background-image:url(images/bg/banner_bg4.jpg);">
      <div class="wrapper">
        <div class="ad_txt">
          <h2>您的网站全职管家</h2>
          <p>成熟的监控与报警机制。<br/>
        ...
        <div class="ad_img"> <img src="images/exhibition/4.png"  width="506" height="404" alt="" /> </div>
      </div>
    </li>
    <li style="background-image:url(images/bg/banner_bg5.jpg);">
      <div class="wrapper">
        <div class="ad_txt">
          <h2>不可忽略的移动终端</h2>
        ...
        <div class="ad_img"> <img src="images/exhibition/5.png" width="506" height="404" alt="" /> </div>
      </div>
    </li>
  ...
  <div id="banner_ctr">
		<div id="dudu">
		    ...
		    <ul id="li-list">
		      ...
		      <li style="background-image: url(images/exhibition/888.png);"> </li>
		      <li style="background-image: url(images/exhibition/888.png);"> </li>
		      <li style="background-image: url(images/exhibition/888.png);"> </li>
		      <li style="background-image: url(images/exhibition/888.png);"> </li>
		      <li style="background-image: url(images/exhibition/888.png);"> </li>
...
<section id="cases2">
  <div class="cat_title wrapper">
    ...
    <a href="photoalbum.jsp"  class="more">MORE+</a> 
  </div>
  <iframe src="photoalbum.jsp" width="1741" height="701" scrolling="auto" frameborder="0" > </iframe>
</section>


<section id="news">
  <div class="cat_title wrapper">
    <h2>最新作品<strong>Products</strong></h2>
    <p>关注我们、关注前沿<br/>
      Recently is to do ...</p>
...
<script type="text/javascript" src="js/exhibition/jquery.1.8.2.min.js" ></script>
<script type="text/javascript" src="js/exhibition/jquery.plugin.min.js"></script>
<script type="text/javascript" src="js/exhibition/zhanshi.js" ></script>
</body>
</html>
